...
<div class="wrap">
	<div id="breadcrumb">
		...
		&raquo;
		<a href="<?php echo bloginfo('url');?>/wp-admin/admin.php?page=informea_pictures&act=pict_highlight_image">Manage highlights pictures</a>
	</div>
	<div id="icon-tools" class="icon32"><br></div>
	<h2>Manage highlights pictures</h2>
	...
	<div class="updated settings-error" id="setting-error-settings_updated">
		<?php
			if($page_data->success) {
				...
				$id_treaty = NULL;
		?>
			<strong>Picture was successfully uploaded!</strong> <a href="<?php bloginfo('url'); ?>/wp-admin/admin.php?page=informea_pictures&act=pict_highlight_image">Add another one!</a>
		<?php } else {?>
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<em class="text-red"><strong>Important</strong>: Image must be exactly <strong>300</strong> pixels wide by <strong>300</strong> pixels height!</em>
	</form>
		...
		<table class="widefat wide">
			...
			?>
				<tr<?php echo ($count % 2 == 0) ? ' class="alternate"' : ''; ?>">
					...
					<td><img src="<?php bloginfo('url');?>/wp-content/uploads/pictures/highlight_image/<?php echo $picture->filename; ?>" />
					</td>
				</tr>
			<?php
					$count++;
