...
<div class="wrap">
    ...
    <h3>Actions</h3>
    <ul>
        <li><a href="<?php echo get_bloginfo('url'); ?>/wp-admin/admin.php?page=informea_nfp&act=add_nfp">Add new focal
                point</a></li>
        <li><a href="<?php echo get_bloginfo('url'); ?>/wp-admin/admin.php?page=informea_nfp&act=edit_nfp">Edit focal
                point</a></li>
        <li><a href="<?php echo get_bloginfo('url'); ?>/wp-admin/admin.php?page=informea_nfp&act=duplicates">Identify
                duplicate contacts</a></li>
    </ul>
