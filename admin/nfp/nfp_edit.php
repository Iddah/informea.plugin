        ...
        <?php if (!empty($people)) { ?>
            <table>
                <tr>
                    ...
                    <td><input type="text" id="original_id" name="" value="<?php echo $people->original_id; ?>"
                ...
                <tr>
                    ...
                    <td><input type="text" id="telephone" name="telephone" value="<?php echo $people->telephone; ?>"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="checkbox" id="is_primary"
                               name="is_primary" <?php echo !empty($people->is_primary) ? 'checked="checked"' : ''; ?> />
                    </td>
                </tr>
                <tr>
            ...
            <?php $c = count($treaties);
            if ($c > 1) { ?>
                <strong class="red">Warning: This contact comes from <?php echo $c; ?> different sources and it might be
                    duplicated! You can try to identify its duplicate and update it accordingly</strong>
            <?php } ?>
            <div class="clear"></div>
            <input type="submit" class="button-primary" name="actioned" style="float: left;" value="Save changes"/>
            <input type="submit" class="button-primary" style="float: left; margin-left: 200px;" name="delete"
                   value="Delete this contact" onclick="return confirm('Are you sure?');"/>
        <?php } ?>
    </form>
</div>
