...
<div id="breadcrumb">
    ...
    &raquo;
    <a href="<?php echo bloginfo('url'); ?>/wp-admin/admin.php?page=informea_treaties&act=treaty_add_treaty">Add new
        treaty</a>
</div>
...
<?php if ($page_data->actioned) { ?>
    <div class="updated settings-error" id="setting-error-settings_updated">
        <?php if ($page_data->success) { ?>
            <p><strong>Treaty was successfully created! See the treaties page <a
                        href="<?php bloginfo('url'); ?>/treaties">here</a>.</p>
        <?php } ?>
        <?php if (!$page_data->success) { ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" id="primary" name="primary"
                           title="Is primary treaty for the organization."<?php echo $disabled;?><?php if (!$page_data->success) {
                        echo $checked;
                    }?>/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="checkbox" id="use_informea"
                           name="use_informea" <?php echo ($page_data->actioned && !$page_data->success && $page_data->get_value('use_informea') == '') ? '' : 'checked="checked"'; ?>
                           value="1"/>
                    &nbsp; If checked, will appear in InforMEA, together with its texts and decisions, otherwise not,
                    but will be used in other sites (IEG)
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" size="60" id="short_title" name="short_title"
                           value="<?php if (!$page_data->success) {
                               echo $page_data->get_value('short_title');
                           } ?>"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" size="60" id="short_title_alternative" name="short_title_alternative"
                           value="<?php if (!$page_data->success) {
                               echo $page_data->get_value('short_title_alternative');
                           } ?>"/>
                    (How title appears on treaties page)
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" size="60" id="long_title" name="long_title"
                           value="<?php if (!$page_data->success) {
                               echo $page_data->get_value('long_title');
                           } ?>"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <textarea rows="5" cols="40" id="abstract" name="abstract"
                        ><?php if (!$page_data->success) {
                            echo $page_data->get_value('abstract');
                        }?></textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="region" name="region"
                           value="<?php if (!$page_data->success) {
                               echo $page_data->get_value('region');
                           } ?>"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <input type="hidden" id="logo_medium" name="logo_medium"
                           value="<?php if (!$page_data->success) {
                               echo $page_data->get_value('logo_medium');
                           } ?>"/>
            ...
            <tr>
                ...
                <td>
                    <input type="text" size="5" id="number_of_parties" name="number_of_parties"
                           value="<?php if (!$page_data->success) {
                               echo $page_data->get_value('number_of_parties');
                           } ?>"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" size="20" id="theme" name="theme"
                           value="<?php if (!$page_data->success) {
                               echo $page_data->get_value('theme');
                           } ?>"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" size="20" id="theme_secondary" name="theme_secondary"
                           value="<?php if (!$page_data->success) {
                               echo $page_data->get_value('theme_secondary');
                           } ?>"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" id="odata_name" name="odata_name" size="20"
                           value="<?php if (!$page_data->success) {
                               echo $page_data->get_value('odata_name');
                           } ?>"/>
                    Unique identification for OData harvesting (put here short string identifying the treaty. No spaces,
                    max. 32 characters, please. examples: barc_prevention, prevention_emerg, cbd, ozone etc.)
                </td>
            </tr>
            <tr>
