...
<div class="wrap">
    <div id="breadcrumb">
        ...
        &raquo;
        <a href="<?php echo bloginfo('url'); ?>/wp-admin/admin.php?page=informea_treaties&act=treaty_add_article">Add
            new article to treaty</a>
    </div>
    ...
    <?php } else { ?>
        ...
        <b>
            You can either add the content of the article here, or go to <a
                href="<?php echo get_bloginfo('url'); ?>/wp-admin/admin.php?page=informea_treaties&act=treaty_add_article_paragraph">Add
                new paragraph to an article</a> and add the article content paragraph by paragraph.
        </b>
    <?php } ?>
                ...
                <tr>
                    ...
                    <td>
                        <textarea rows="5" cols="40" id="content"
                                  name="content"><?php if (!$page_data->success) {
                                echo $page_data->get_value('content');
                            }?></textarea>
                    </td>
                </tr>
        ...
        <?php if ($id_treaty) { ?>
            <p class="submit">
                <input name="actioned" type="submit" class="button-primary"
                       value="<?php esc_attr_e('Add article'); ?>"/>
            </p>
        <?php } ?>
    </form>
</div>
