...
<div class="wrap">
    <div id="breadcrumb">
        ...
        &raquo;
        <a href="<?php echo bloginfo('url'); ?>/wp-admin/admin.php?page=informea_treaties&act=treaty_add_organization">Add
            new organization</a>
    </div>
        ...
        <tr>
            ...
            <td>
                <input type="text" size="60" id="address" name="address"
                       value="<?php if (!$page_data->success) {
                           echo $page_data->get_value('address');
                       } ?>"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" size="60" id="depository" name="depository"
                       value="<?php if (!$page_data->success) {
                           echo $page_data->get_value('depository');
                       } ?>"/>
            </td>
        </tr>
    </table>
