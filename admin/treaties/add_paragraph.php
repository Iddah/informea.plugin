...
<div class="wrap">
    <div id="breadcrumb">
        ...
        &raquo;
        <a href="<?php echo bloginfo('url'); ?>/wp-admin/admin.php?page=informea_treaties&act=treaty_add_article_paragraph">Add
            new paragraph to an article</a>
    </div>
    ...
    <?php
        ...
        <p>
            View the selected <a
                href="<?php echo $page_data->get_article_url_in_treaty($id_treaty, $id_treaty_article); ?>">article</a>.
        </p>
        <p>
        ...
        <?php if ($id_treaty_article) { ?>
            <p class="submit">
                <input name="actioned" type="submit" class="button-primary"
                       value="<?php esc_attr_e('Add paragraph'); ?>"/>
            </p>
        <?php } ?>
    </form>
</div>
