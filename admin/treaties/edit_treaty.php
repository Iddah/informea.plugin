...
<div class="wrap">
    <div id="breadcrumb">
        ...
        &raquo;
        <a href="<?php echo bloginfo('url'); ?>/wp-admin/admin.php?page=informea_treaties&act=treaty_edit_treaty">Edit
            treaty</a>
    </div>
        ...
        <?php if ($page_data->actioned) { ?>
            <div class="updated settings-error" id="setting-error-settings_updated">
                <?php if ($page_data->success) { ?>
                    <p><strong>Treaty was successfully updated!</strong> See the front-page view <a
                            href="<?php bloginfo('url'); ?>/treaties/<?php echo $treaty->odata_name; ?>">here</a>.</p>
                <?php } ?>
                <?php if (!$page_data->success) { ?>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        <input name="select_treaty" type="submit" class="button-primary"
                ...
                <tr>
                    ...
                    <td><input type="text" size="60" id="short_title" name="short_title"
                               value="<?php echo $treaty->short_title; ?>"/></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" size="60" id="short_title_alternative" name="short_title_alternative"
                               value="<?php echo $treaty->short_title_alternative; ?>"/> (How title appears on treaties
                        page)
                    </td>
                </tr>
                <tr>
                    <td><label for="long_title">Long title</label></td>
                    <td><input type="text" size="60" id="long_title" name="long_title"
                ...
                <tr>
                    ...
                    <td><textarea rows="5" cols="40" id="abstract"
                                  name="abstract"><?php echo $treaty->abstract;?></textarea></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="hidden" id="logo_medium" name="logo_medium"
                               value="<?php echo $treaty->logo_medium; ?>"/>
                ...
                <tr>
                    ...
                    <td><input type="text" size="5" id="number_of_parties" name="number_of_parties"
                               value="<?php echo ($treaty->number_of_parties > 0) ? $treaty->number_of_parties : ''; ?>"/>
                    </td>
                </tr>
                <tr>
                    <td><label for="theme">Primary theme</label></td>
                    <td><input type="text" size="60" id="theme" name="theme" value="<?php echo $treaty->theme; ?>"/>
                    </td>
                </tr>
                <tr>
                    <td><label for="theme_secondary">Secondary theme</label></td>
                    <td><input type="text" size="60" id="theme_secondary" name="theme_secondary"
                               value="<?php echo $treaty->theme_secondary; ?>"/></td>
                </tr>
                <tr>
                    <td><label for="enabled">Enabled</label></td>
                    <td>
                        <input type="checkbox" id="enabled"
                               name="enabled" <?php echo $treaty->enabled ? 'checked="checked"' : ''; ?> value="1"/>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" id="use_informea"
                               name="use_informea" <?php echo $treaty->use_informea == 1 ? 'checked="checked"' : ''; ?>
                               value="1"/>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        (number used to order the items on 'treaties' page. Make it higher to move the treaty to end of
                        the list)
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" size="20" id="odata_name" name="odata_name"
                               value="<?php echo $treaty->odata_name; ?>"/>
                        (OData identification. Do not modify unless you are sure what you are doing. No spaces and
                        maximum 32 characters please!)
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <br/>
                        <em class="error">Use <strong>(Ctrl, Shift) + Click</strong> to select/deselect multiple item(s)
                            and range of terms</em>
                        <br/>
