...
<div class="wrap">
    <div id="breadcrumb">
        ...
        &raquo;
        <a href="<?php echo bloginfo('url'); ?>/wp-admin/admin.php?page=informea_treaties&act=treaty_edit_article">Edit
            an article from treaty</a>
    </div>
        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <input name="select_article" type="submit" class="button-primary"
