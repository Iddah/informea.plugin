...
<div class="wrap">
	<div id="breadcrumb">
		...
		&raquo;
		<a href="<?php echo bloginfo('url');?>/wp-admin/admin.php?page=informea_national_plans&act=edit_national_plan">Edit national plan</a>
	</div>
	...
	<form action="" method="post" id="edit_form">
		...
		<table>
			...
			<tr>
				...
				<td>
					<input type="text" size="60" id="submission" name="submission" value="<?php echo $plan->submission; ?>" />
				</td>
			</tr>
			<tr>
				<td><label for="document_url">Document URL *</label></td>
				<td>
					<input type="text" size="60" id="document_url" name="document_url" value="<?php echo $plan->document_url; ?>" />
				</td>
			</tr>
		</table>
