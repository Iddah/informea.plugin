        ...
        <form id="delete_decision" action="" method="post" enctype="multipart/form-data" class="validate">
            ...
            if ($id_treaty) {
                ...
                if (count($decisions)) {
                    ?>
                    <p class="submit">
                        <input type="submit" name="actioned" value="Delete selected"
                               onclick="return confirm('Remove selected decisions and ALL their associated data (documents, tags, paragraphs etc.)? This CANNOT be undone!');"/>
                    </p>
                    <table class="widefat">
                        <thead>
                        <tr>
                        ...
                        foreach ($decisions as $idx => $decision) {
                            ...
                            <tr<?php echo $css; ?>>
                                <td>
                                    <input type="checkbox" id="id_decision_<?php echo $decision->id; ?>"
                                           name="id_decision[]" value="<?php echo $decision->id; ?>"/>
                                </td>
                                <td>
