            ...
            <div id="col-container">
                <div id="col-right">
                    ...
                    <div class="form-field">
                        ...
                        <textarea id="summary" name="summary" rows="5" cols="20"
                                  tabindex="12"><?php echo get_request_value('summary', ''); ?></textarea>
                    </div>

                    <div class="form-field">
                        <label for="body">Text</label>
                        <textarea id="body" name="body" rows="15" cols="20"
                                  tabindex="13"><?php echo get_request_value('body', ''); ?></textarea>
                    </div>
                ...
                <div id="col-left">
                    <div class="form-field">
                        ...
                        <select id="id_organization" name="id_organization" tabindex="1">
                            ...
                            foreach ($treatyOb->get_organizations() as $org) {
                                ...
                                ?>
                                <option
                                    value="<?php echo $org->id; ?>"<?php echo $selected; ?>><?php echo $org->name; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    ...
                    <div class="form-field form-required">
                        ...
                        <input type="text" id="short_title" name="short_title"
                               value="<?php echo get_request_value('short_title', ''); ?>" tabindex="4"/>
                    </div>

                    <div class="form-field form-required">
                        <label for="number">Number *</label>
                        <input type="text" id="number" name="number"
                               value="<?php echo get_request_value('number', ''); ?>" style="width: 200px;"
                               tabindex="5"/>
                    </div>
                    ...
                    <div class="form-field form-required">
                        <div>
                            ...
                            <input type="text" id="published" name="published"
                                   value="<?php echo get_request_value('published', ''); ?>" style="width: 150px;"
                                   tabindex="6"/>
