...
<div class="wrap">
	<div id="breadcrumb">
		...
		&raquo;
		<a href="<?php echo bloginfo('url');?>/wp-admin/admin.php?page=informea_decisions&act=decision_edit_decision">Tag decision paragraphs</a>
	</div>
	<div id="icon-tools" class="icon32"><br></div>
	<h2>Tag decision paragraphs</h2>
	<p>
		On this page you can tag paragraphs of a decision. <span style="color:red">To tag entire decisions, please go <strong><a href="<?php echo get_bloginfo('url'); ?>/wp-admin/admin.php?page=informea_decisions&act=decision_edit_tags">here</a></strong></span>.
	</p>
	<form action="" method="get" id="edit_form">
		...
		<table class="wp-list-table widefat fixed">
			<thead>
				<tr><th width="15%">Key</th><th>Value</th></tr>
			</thead>
			<tbody>
				<tr><td>Title</td><td><?php echo $decision->short_title; ?></td></tr>
				<tr>
					<td>Type, Status</td>
					<td>
						<?php echo decode_decision_type($decision->type); ?>, <?php echo decode_decision_status($decision->status); ?>
					</td>
				</tr>
				<tr><td>Number</td><td><?php echo $decision->number; ?></td></tr>
				<?php if(!empty($decision->event_title)) { ?>
				<tr><td>Meeting</td><td><?php echo $decision->event_title; ?></td></tr>
				<?php } ?>
