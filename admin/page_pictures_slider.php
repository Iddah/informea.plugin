...
<div class="wrap">
    <div id="breadcrumb">
        ...
        &raquo;
        <a href="<?php echo bloginfo('url'); ?>/wp-admin/admin.php?page=informea_pictures&act=pict_slider">Manage
            front-page slide image</a>
    </div>
        ...
        <div class="updated settings-error" id="setting-error-settings_updated">
            ...
            if ($page_data->success) {
                ...
                <strong>Picture was successfully uploaded!</strong> <a
                    href="<?php bloginfo('url'); ?>/wp-admin/admin.php?page=informea_pictures&act=pict_slider">Add
                    another one!</a>
            <?php } else { ?>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <em class="text-red"><strong>Important</strong>: Image must be exactly <strong>600</strong> pixels wide by
            <strong>200</strong> pixels height!</em>
    </form>
        ...
        <form action="" method="post"
            ...
            <table class="widefat wide">
                ...
                foreach ($pictures as $key => $picture) {
					...
					<td><img
                            src="<?php bloginfo('url'); ?>/wp-content/uploads/pictures/slide_images/<?php echo $picture->filename; ?>"/>
                    </td>
				</tr>
			<?php
					$count++;
