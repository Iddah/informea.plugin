...
<div class="wrap">
	<div id="breadcrumb">
		...
		&raquo;
		<a href="<?php echo bloginfo('url');?>/wp-admin/admin.php?page=informea_national_reports&act=add_national_report">Add new national report</a>
	</div>
	...
	<form action="" method="post" id="sel_form">
		...
		<p class="submit">
			<input name="actioned" type="submit" class="button-primary" value="<?php esc_attr_e('Add national report'); ?>" />
		</p>
	</form>
</div>
