...
if(!empty($id_national_report)) {
	...
	$events = $page_events->get_events($report->id_treaty);
}
?>
...
<div class="wrap">
	<div id="breadcrumb">
		...
		&raquo;
		<a href="<?php echo bloginfo('url');?>/wp-admin/admin.php?page=informea_national_reports&act=edit_national_report">Edit national report</a>
	</div>
	...
	<form action="" method="post" id="edit_form">
		...
		<table>
			...
			<tr>
				...
				<td>
					<input type="text" size="60" id="submission" name="submission" value="<?php echo $report->submission; ?>" />
				</td>
			</tr>
			<tr>
				<td><label for="document_url">Document URL *</label></td>
				<td>
					<input type="text" size="60" id="document_url" name="document_url" value="<?php echo $report->document_url; ?>" />
				</td>
			</tr>
		</table>
