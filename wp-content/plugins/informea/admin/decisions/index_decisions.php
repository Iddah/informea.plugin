...
<div class="wrap">
	...
	<table class="widefat fixed">
		...
		<tr>
			<td><a href="<?php bloginfo('url'); ?>/wp-admin/admin.php?page=informea_decisions&act=decision_edit&id_treaty=<?php echo $decision->id_treaty;?>&id_decision=<?php echo $decision->id; ?>">Edit</a></td>
