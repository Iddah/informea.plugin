...
<div class="wrap">
	<div id="breadcrumb">
		...
		&raquo;
		<a href="<?php echo bloginfo('url');?>/wp-admin/admin.php?page=informea_nfp&act=duplicates">Duplicate focal points</a>
	</div>
	<div id="icon-tools" class="icon32"><br></div>
	<h2>Duplicate focal points</h2>

	<p>
		From this page you can identify focal points. Although there is nothing to do for the moment with them, you can still try to synchronize their contact details manually
	</p>
	...
	<form action="" method="get">
		...
		<ul>
			...
			<li><input type="checkbox" id="first_name" name="group[]" value="first_name" <?php echo $checked; ?> /><label for="first_name">First name</label></li>
			<?php $checked=in_array('last_name', $group) ? 'checked="checked"' : ''; ?>
			<li><input type="checkbox" id="last_name" name="group[]" value="last_name" <?php echo $checked; ?> /><label for="last_name">Last name</label></li>
			<?php $checked=in_array('email', $group) ? 'checked="checked"' : ''; ?>
			<li><input type="checkbox" id="email" name="group[]" value="email" <?php echo $checked; ?> /><label for="email">Email</label></li>
		</ul>
