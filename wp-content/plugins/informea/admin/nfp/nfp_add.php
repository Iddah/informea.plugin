<div class="wrap">
	<div id="breadcrumb">
		...
		&raquo;
		<a href="<?php echo bloginfo('url');?>/wp-admin/admin.php?page=informea_nfp&act=add_nfp">Add new focal point</a>
	</div>
	...
	<form action="" method="post" id="edit_form">
		...
		<table>
			<tr>
				...
				<td><input type="text" id="prefix" name="prefix" value="<?php echo get_request_value('prefix'); ?>" /></td>
			</tr>
			<tr>
				<td><label for="first_name">First name</label></td>
				<td><input type="text" id="first_name" name="first_name" value="<?php echo get_request_value('first_name'); ?>" /></td>
			</tr>
			<tr>
				<td><label for="last_name">Last name</label></td>
				<td><input type="text" id="last_name" name="last_name" value="<?php echo get_request_value('last_name'); ?>" /></td>
			</tr>
			<tr>
				<td><label for="position">Position</label></td>
				<td><input type="text" id="position" name="position" size="40" value="<?php echo get_request_value('position'); ?>" /></td>
			</tr>
			<tr>
				<td><label for="institution">Institution</label></td>
				<td><input type="text" id="institution" name="institution" size="40" value="<?php echo get_request_value('institution'); ?>" /></td>
			</tr>
			<tr>
				<td><label for="department">Department</label></td>
				<td><input type="text" id="department" name="department" size="40" value="<?php echo get_request_value('department'); ?>" /></td>
			</tr>
			<tr>
				<td><label for="address">Address</label></td>
				<td><textarea type="text" id="address" name="address" size="40" rows="5" cols="30"><?php echo get_request_value('address'); ?></textarea></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" id="telephone" name="telephone" value="<?php echo get_request_value('telephone'); ?>" /></td>
			</tr>
			<tr>
				<td><label for="fax">Fax</label></td>
				<td><input type="text" id="fax" name="fax" size="40" value="<?php echo get_request_value('fax'); ?>" /></td>
			</tr>
			<tr>
				<td><label for="is_primary">Primary NFP?</label></td>
				<td><input type="checkbox" id="is_primary" name="is_primary" <?php echo get_request_boolean('is_primary') ? 'checked="checked"' : '' ; ?> /></td>
			</tr>
			<tr>
