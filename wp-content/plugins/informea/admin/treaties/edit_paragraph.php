...
<div class="wrap">
	<div id="breadcrumb">
		...
		&raquo;
		<a href="<?php echo bloginfo('url');?>/wp-admin/admin.php?page=informea_treaties&act=treaty_edit_article_paragraph">Edit article paragraph</a>
	</div>
	...
	<?php } else { ?>
		<p>
			View the selected <a href="<?php echo $page_data->get_paragraph_url_in_treaty($id_treaty, $id_treaty_article, $id_treaty_article_paragraph);?>">paragraph</a>.
		</p>
		<p>
	...
	<form action="" method="post">
		<table>
			<tr>
				...
				<input name="select_paragraph" type="submit" class="button-primary" value="<?php esc_attr_e('select'); ?>" />
				</td>
			</tr>
		</table>
		<p>
