...
class Newsletter {
    ...
    function hook_admin_head() {
        if (isset($_GET['page']) && strpos($_GET['page'], 'newsletter/') === 0) {
    ...
    function hook_init() {
        ...
        $action = isset($_REQUEST['na']) ? $_REQUEST['na'] : null;
    ...
    function hook_admin_init() {
        global $wpdb;
        if (isset($_REQUEST['act']) && $_REQUEST['act'] == 'export' && check_admin_referer()) {
