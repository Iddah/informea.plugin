	...
	<li>
		...
		<?php
			foreach($treaties as $id => $data) {
				$children = $data['children']; $title = $data['title']; $theme = $data['theme'];
		...
		?>
				<li>
					...
					<label for="explorer_treaty_<?php echo $id; ?>">
						<?php echo $title; ?><?php if($theme) { ?><span class="description" style="color: #777777 !important; font-size: 12px !important;"><?php echo '('.$theme.')'; ?></span><?php } ?>
					</label>
					...
					?>
						<li>
							<input id="explorer_treaty_<?php echo $id; ?>" type="checkbox" name="q_treaty[]" value="<?php echo $id; ?>" checked="checked" />
							<label for="explorer_treaty_<?php echo $id; ?>">
								<?php echo $title; ?>
...
<ul class="main-list">
	<li>
		<input id="explorer_other_treaties" type="checkbox" checked="checked" class="explorer-treaty-click-children" />
		...
		<ul class="sublist">
			<li>
				<?php
					...
					foreach($ot as $id) {
				?>
				<input type="checkbox" id="explorer_treaty_<?php echo $id; ?>" name="q_treaty[]" value="<?php echo $id; ?>" checked="checked" class="hidden" />
				<?php } ?>
			</li>
		</ul>
	</li>
